...
# ## Conclusion
# The null hypothesis proposed is that the growth in $\textrm{CO}_2$ over the past few decades can be modeled by a function of the form
# ```{math}
...
# 
# ### Discussion
# The $\chi^2_{min}$ value of the model fit was substantially lower than that of previous just polynomial fits. This is reassuring as adding annual, biannual cycles in $\textrm{CO}_2$ levels corresponds with seasonal increases in $\textrm{CO}_2$ absorption by flora.
# 
# ```{Note}
# Do Some Citations
# ``` 
